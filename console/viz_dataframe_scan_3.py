...
cluster_folder = r'/lustre/fs25/group/pitz/duoxup/THz_ideal_machine/genesis/cluster00000003/'
...
fig, axes = plot_scan_facets(df=dfc,
                             ...
                             hue='oth_q',
                             # hue='sig_x',
                             facet_vars=['oth_beta_x0', 'gen_input_cor_ekin'],
                             config=psc,
                             mode='heatmap',   #line or heatmap
                             colorbar='all',
                             cmap='viridis',
